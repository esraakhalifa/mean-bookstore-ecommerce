...
router.patch('/book/:id/:rid', async (req, res) => res.json(await BooksControllers.updateReview(req.params.rid, {user: req.user, comment: req.body.comment, rating: req.body.rating})));
